  ...
  return (
    <div className="w-[292px] rounded-2xl border border-gray-200 bg-white p-5 shadow-lg">
      ...
      <div className="flex items-center gap-3 pb-4">
        <Image src={avatarSrc} alt="" width={36} height={36} className="rounded-full" />
      ...
      <div className="flex flex-col gap-1 pt-4">
        <Link href={myChallengeHref} className="text-sm font-medium text-gray-900 hover:text-gray-600">
          나의 챌린지
        </Link>
